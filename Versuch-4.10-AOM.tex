...
$$Q = \frac{2 \pi \lambda_L L}{\Gamma^2 n_0}$$,

wobei $\lambda_L$ die Lichtwellenlänge ist, L die Länge des Kristalls im AOM (L kann mit etwa 15 mm abgeschätzt werden), $\Gamma$ die Gitterkonstante (also die Schallwellenlänge im Kristall gemäß $\lambda_S = \frac{v_S}{f_S}$) und $n_0$ der mittlere Brechungsindex, welcher für Tellurdioxid bei 486 nm einen Wert von $n_0 = 2,24$ besitzt \cite{wiki}.

Es ergibt sich für unsere Sitution ein Q-Wert von etwa 9,4, was der Einschätzung des Parameters $\rho$ entspricht, da ab einem Q-Wert von 10 Bragg-Regime vorliegt und der Q-Wert ganz knapp an der Grenze liegt. Wir gehen daher davon aus, dass einerseits die Berechnung gemäß des Bragg-Regimes gerechtfertigt ist und sich andererseits mit diesem Q-Wert auch das Auftreten höherer Beugungsordnungen erklären lässt.
